...
class Upload {
    ...
    public $allowtype   = array('gif', 'jpg', 'png', 'jpeg'); //充许上传文件的类型
    private $maxsize    = 2000000; //允上传文件的最大长度 1M
    private $israndname = true; //是否随机重命名， false不随机，使用原文件名
    private $originName; //源文件名称
    private $tmpFileName; //临时文件名
    private $fileType; //文件类型
    private $fileSize; //文件大小
    private $oldName; //旧文件名
    ...
    private function getError()
    {
        ...
        switch ($this->errorNum)
        {
            ...
            case 2: $str .= "上传文件超过了限制";
                break;

            case 1: $str .= "上传文件超过了限制";
                break;

            case -1: $str .= "不支持该格式的图片";
                break;
    ...
    function uploadFile($fileField, $t)
    {
        $this->filepath .=  $t . '/';
        $return = true;
